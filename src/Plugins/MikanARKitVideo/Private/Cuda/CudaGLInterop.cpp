...
{
	// Same WRITE_DISCARD | SURFACE_LDST rationale as CudaGLDepthTexture -
	// NV12ConversionKernel overwrites the entire texture every frame via
	// surf2Dwrite, never reads back prior contents.
	const unsigned int registerFlags=
		CU_GRAPHICS_REGISTER_FLAGS_WRITE_DISCARD | CU_GRAPHICS_REGISTER_FLAGS_SURFACE_LDST;

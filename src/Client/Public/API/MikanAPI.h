...
// -- Render Target API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanRenderTargetAPI
{
public:
...
// -- Script API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanScriptAPI
{
public:
	IMikanScriptAPI() {}
...
// -- Spatial Anchor API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanSpatialAnchorAPI
{
public:
...
// -- Stencil API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanStencilAPI
{
public:
	IMikanStencilAPI() {}
...
// -- Video Source API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanVideoSourceAPI
{
public:
...
// -- VRDevice API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanVRDeviceAPI
{
public:
	IMikanVRDeviceAPI() {}
...
// -- Mikan API -----
class MIKAN_CLIENT_CLASS CLASS() IMikanAPI
{
public:
	IMikanAPI() = default;

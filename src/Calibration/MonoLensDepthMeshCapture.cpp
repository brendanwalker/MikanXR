...
float MonoLensDepthMeshCapture::getCalibrationProgress() const
{
...
bool MonoLensDepthMeshCapture::computeCameraToPuckXform()
{
	// Gather inputs
	//---------------
...
glm::mat4 MonoLensDepthMeshCapture::getLastCameraPose(VRDeviceViewPtr attachedVRDevicePtr) const
{
...
void MonoLensDepthMeshCapture::sampleLastCameraToPuckXform()
{
...
bool MonoLensDepthMeshCapture::computeCalibratedCameraTrackerOffset(

...
glm::vec2 remapPointIntoTarget(const float screenWidth, const float screenHeight, const float windowLeft,
							   const float windowTop, const float windowRight, const float windowBottom,
...
void drawQuadList2d(IMkGraphicsContext* graphicsContext, const float trackerWidth, const float trackerHeight,
					const float* point_data_2d, const int point_count, const glm::vec3& color);

void drawOpenCVChessBoard2D(IMkGraphicsContext* graphicsContext, const float trackerWidth, const float trackerHeight,
							const float* points2d, const int point_count, bool validPoints);

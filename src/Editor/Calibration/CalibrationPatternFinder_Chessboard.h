...
{
public:
	CalibrationPatternFinder_Chessboard(VideoFrameDistortionView* distortionView, int m_chessbordRows,
										int m_chessbordCols, float squareLengthMM);

	virtual eCalibrationPatternType getCalibrationPatternType() const override
	{
		return eCalibrationPatternType::mode_chessboard;
	}

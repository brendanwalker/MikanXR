...
void GuiDataSource_StringList::setEntries(const std::vector<std::string>& entries) { m_entries= entries; }
...
int GuiDataSource_StringList::getEntryCount() const { return (int)m_entries.size(); }

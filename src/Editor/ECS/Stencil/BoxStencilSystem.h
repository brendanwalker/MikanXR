...
class BoxStencilSystem : public MikanTypedObjectSystem<BoxStencilComponent, BoxStencilDefinition, MikanStencilID,
													   BoxStencilSystem, BoxStencilSystemDefinition>
{
public:
	using Super= MikanTypedObjectSystem<BoxStencilComponent, BoxStencilDefinition, MikanStencilID, BoxStencilSystem,
	...
	void getRelevantBoxStencilList(const std::vector<MikanStencilID>* allowedStencilIds,

...
void drawPoint(
	...
	const glm::mat4& transform, const glm::vec3& point, const glm::vec3& color, const float size);
void drawSegment(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, const glm::vec3& start, const glm::vec3& end, const glm::vec3& color);
void drawSegment(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, const glm::vec3& start, const glm::vec3& end, const glm::vec3& colorStart, const glm::vec3& colorEnd);
void drawArrow(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, const glm::vec3& start, const glm::vec3& end, const float headFraction, const glm::vec3& color);
void drawGrid(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, float xSize, float ySize, int xSubDiv, int ySubDiv, const glm::vec3& color);
...
void drawTransformedAxes(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, float xScale, float yScale, float zScale, bool drawLabels= false);
void drawTransformedAxes(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform,
...
void drawTransformedTriangle(
	IMkGraphicsContext* graphicsContext,
	const glm::mat4& transform, const struct GlmTriangle& tri, const glm::vec3& color);

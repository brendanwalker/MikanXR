...
int TextureSourceListDataSource::getEntryCount() const { return (int)comboEntrieValues.size(); }
...
const std::string& TextureSourceListDataSource::getEntryDisplayString(int index) const
{

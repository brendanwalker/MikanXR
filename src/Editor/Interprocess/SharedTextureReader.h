...
public:
	...
	void setShadowTexture(IMkTexturePtr texture) { m_shadowTexture= texture; }
	...
	inline IMkTexturePtr getShadowTexture() const { return m_shadowTexture; }

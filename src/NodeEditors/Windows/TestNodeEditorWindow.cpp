//-- includes -----
#include "TestNodeEditorWindow.h"
#include "Logger.h"
...
GlLineRenderer* TestNodeEditorWindow::getLineRenderer()
{
	return nullptr;
}

GlTextRenderer* TestNodeEditorWindow::getTextRenderer()
{
	return nullptr;
}

GlStateStack& TestNodeEditorWindow::getGlStateStack()
{
	return *m_glStateStack.get();
}

bool TestNodeEditorWindow::startup()
{
	EASY_FUNCTION();

	bool success = true;

	MIKAN_LOG_INFO("TestNodeEditorWindow::init()") << "Initializing NodeEditorWindow";
	...
	if (success)
	{
		...
		{
			MIKAN_LOG_ERROR("TestNodeEditorWindow::startup") << "Unable to create imgui context";
			success = false;
		}
	}
	...
	if (success)
	{
		...
		{
			MIKAN_LOG_ERROR("TestNodeEditorWindow::startup") << "Unable to initialize imgui SDL backend";
			success = false;
		}
	}
	...
	if (success)
	{
		...
		{
			MIKAN_LOG_ERROR("TestNodeEditorWindow::startup") << "Unable to initialize imgui openGL backend";
			success = false;
		}
	}
	...
	if (success)
	{
		...
		{
			MIKAN_LOG_ERROR("TestNodeEditorWindow::startup") << "Unable to create imnodes context";
			success = false;
		}
	}
	...
	{
		MIKAN_LOG_ERROR("TestNodeEditorWindow::startup") << "Failed to initialize shader cache!";
		success = false;
	}
...
void TestNodeEditorWindow::update()
{
	EASY_FUNCTION();
...
void TestNodeEditorWindow::render()
{
	EASY_FUNCTION();
...
void TestNodeEditorWindow::renderUI()
{
	pushImGuiStyles();
...
void TestNodeEditorWindow::renderToolbar()
{
...
void TestNodeEditorWindow::renderLeftPanel()
{
...
void TestNodeEditorWindow::renderMainFrame()
{
...
void TestNodeEditorWindow::renderBottomPanel()
{
...
void TestNodeEditorWindow::renderRightPanel()
{
	ImGui::SameLine();
...
void TestNodeEditorWindow::DeleteSelectedItem()
{
...
void TestNodeEditorWindow::AddProgram(GlProgramPtr pProgram)
{
	m_Programs.push_back(pProgram);
}

void TestNodeEditorWindow::DeleteProgram(int ix)
{
	bool needsUpdate = false;
	for (auto& node : m_Nodes)
	{
...
void TestNodeEditorWindow::AddFramebuffer(GlFrameBufferPtr pFramebuffer)
{
	m_Framebuffers.push_back(pFramebuffer);
}

void TestNodeEditorWindow::DeleteFramebuffer(int ix)
{
	if (ix == 0)
		return;
...
void TestNodeEditorWindow::AddTexture(GlTexturePtr pTex)
{
	m_Textures.push_back(pTex);
}

void TestNodeEditorWindow::DeleteTexture(int ix)
{
	bool needsUpdate = false;
	for (auto& node : m_Nodes)
	{
...
void TestNodeEditorWindow::UpdateNodes()
{
...
void TestNodeEditorWindow::UpdatePins()
{
...
void TestNodeEditorWindow::UpdateLinks()
{
...
void TestNodeEditorWindow::DeletePin(EditorPinPtr pin)
{
...
void TestNodeEditorWindow::DeleteNodePinsAndLinks(int id)
{
...
void TestNodeEditorWindow::DeleteNode(int id)
{
	ImNodes::ClearNodeSelection();
	m_SelectedItemType = SelectedItemType::NONE;
	m_SelectedItemId = -1;
...
void TestNodeEditorWindow::DeleteLink(int id, bool checkPingPongNodes)
{
	ImNodes::ClearLinkSelection();
	m_SelectedItemType = SelectedItemType::NONE;
	m_SelectedItemId = -1;
...
void TestNodeEditorWindow::CreateLink(int startPinId, int endPinId)
{
...
ImNodesPinShape TestNodeEditorWindow::BeginPin(EditorPinPtr pin, float alpha)
{
...
void TestNodeEditorWindow::EndPin()
{
	ImNodes::PopColorStyle();
	ImNodes::PopColorStyle();
}

void TestNodeEditorWindow::InputPin(EditorNodePtr node, EditorPinPtr pin)
{
	float alpha = 0.2f;
	if (m_StartedLinkPinId == -1)
		alpha = 1.0f;
...
void TestNodeEditorWindow::OutputPin(EditorNodePtr node, EditorPinPtr pin)
{
	float alpha = 0.2f;
	if (m_StartedLinkPinId == -1)
		alpha = 1.0f;
...
EditorPinPtr TestNodeEditorWindow::GetConnectedPin(EditorNodePtr node, EditorLinkPtr link)
{
	return (link->pPin1->ownerNode == node) ? link->pPin2 : link->pPin1;
}

void TestNodeEditorWindow::GetInputTargetNode(EditorNodePtr& connectedNode, EditorPinType type, int index)
{
...
void TestNodeEditorWindow::ExecuteProgramNode(EditorProgramNodePtr progNode)
{
	// Setup program
...
void TestNodeEditorWindow::shutdown()
{
...
float TestNodeEditorWindow::getWidth() const
{
	return (float)m_sdlWindow->getWidth();
}

float TestNodeEditorWindow::getHeight() const
{
	return (float)m_sdlWindow->getHeight();
}

float TestNodeEditorWindow::getAspectRatio() const
{
...
void TestNodeEditorWindow::configImNodes()
{
...
void TestNodeEditorWindow::pushImGuiStyles()
{
...
void TestNodeEditorWindow::popImGuiStyles()
{
	ImGui::PopFont();
	ImGui::PopStyleVar(7);
...
// TODO: Move to Nodes
EditorPinPtr TestNodeEditorWindow::AllocPin(const GlProgramUniform& uniform)
{
	EditorPinPtr pin;
...
EditorPinPtr TestNodeEditorWindow::AllocPin(const GlShaderVar& var)
{
...
EditorProgramNodePtr TestNodeEditorWindow::CreateProgramNodePtr(int progId, const ImVec2& pos)
{
...
void TestNodeEditorWindow::CreateProgramNode(int progId, const ImVec2& pos)
{
...
void TestNodeEditorWindow::UpdateProgramNode(int nodeId, int progId)
{
	// Create new node
...
void TestNodeEditorWindow::SetProgramNodeFramebuffer(EditorProgramNodePtr node, int framebufferId)
{
	int outPinId = 0;
...
void TestNodeEditorWindow::CreateBlockNode(const ImVec2& pos, int pinId)
{
...
void TestNodeEditorWindow::CreateTextureNode(int textureId, const ImVec2& pos)
{
...
void TestNodeEditorWindow::CreateImageNode(const ImVec2& pos)
{
...
void TestNodeEditorWindow::CreatePingPongNode(const ImVec2& pos, EditorPingPongNodeType type)
{
...
void TestNodeEditorWindow::UpdatePingPongNode(int nodeId, EditorPingPongNodeType type)
{
...
void TestNodeEditorWindow::CreateTimeNode(const ImVec2& pos)
{
...
void TestNodeEditorWindow::CreateMousePosNode(const ImVec2& pos)
{
	EditorNodePtr node = std::make_shared<EditorNode>();

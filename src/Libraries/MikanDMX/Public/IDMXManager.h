...
public:
	...
	virtual void setChannels(uint16_t universe, uint16_t startChannel, const uint8_t* values, uint16_t count)= 0;
	...
	virtual void setUniverseData(uint16_t universe, const uint8_t* slotData, uint16_t slotCount)= 0;

...
enum class eVideoColorMatrix : int
{
	...
	YCgCo, // YCbCr pixels are actually YCoCg pixels.The matrix to convert such pixels to RGB is defined in ISO / IEC 23091 - 2.
...
// These mirror the WMF constants here https://learn.microsoft.com/en-us/windows/win32/api/mfobjects/ne-mfobjects-mfvideotransferfunction

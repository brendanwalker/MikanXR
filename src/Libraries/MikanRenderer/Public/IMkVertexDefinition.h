...
public:
	...
	virtual bool isCompatibleAttribute(const IMkVertexAttribute& other) const = 0;
...
public:
	...
	virtual const std::vector<GlVertexAttribute>& getAttributes() const = 0;
	...
	virtual bool isCompatibleDefinition(const IMkVertexDefinition& other) const = 0;
	virtual bool isCompatibleProgram(const class IMkShader& program) const = 0;
};

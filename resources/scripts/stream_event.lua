...
--
--   http://127.0.0.1:8090/trigger/new_sub?user=bob&tier=3
--
...
function on_new_sub(args)
	...
	ScriptContext.broadcastMessage(string.format("new_sub:%s:%d", user, tier))
...
ScriptContext.registerTrigger("on_new_sub")
ScriptContext.registerHttpTrigger("new_sub", "on_new_sub")

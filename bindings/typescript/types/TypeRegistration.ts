...
import { MikanLightDMXDataResponse, SetLightDMXData, SetLightDMXDataSubcription, GetLightDMXData } from './MikanLightRequests.js';
import { MikanDMXData, MikanDMXObjectSystemValues, MikanRGBSpotLightSystemValues, MikanRGBPixelGridSystemValues, MikanDMXFixtureComponentValues, MikanRGBSpotLightComponentValues, MikanRGBPixelGridComponentValues } from './MikanLightTypes.js';
...
import { MikanMatrix4f, MikanVector3d, MikanMatrix3d, MikanMatrix4d, MikanRotator3f, MikanQuatf, MikanVector2i, MikanVector4f, MikanVector2f, MikanVector2d, MikanTransform, MikanVector3f, MikanVector4d, MikanMatrix4x3d, MikanQuatd } from './MikanMathTypes.js';
...
import { MikanPropertyValue, MikanSystemValues, MikanPropertyDescriptor } from './MikanPropertyTypes.js';
...
export function registerAllTypes(): void {
  ...
  TypeRegistry.register('MikanLightDMXDataResponse', MikanLightDMXDataResponse);
  TypeRegistry.register('SetLightDMXData', SetLightDMXData);
  TypeRegistry.register('SetLightDMXDataSubcription', SetLightDMXDataSubcription);
  TypeRegistry.register('GetLightDMXData', GetLightDMXData);

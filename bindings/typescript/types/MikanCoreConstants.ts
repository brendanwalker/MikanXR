...
export enum MikanClientGraphicsApi {
  UNKNOWN = -1,
  Direct3D9 = 0,
  Direct3D11 = 1,
  Direct3D12 = 2,
...
export enum MikanColorBufferType {
  NOCOLOR = 0,
  RGB24 = 1,
  RGBA32 = 2,
  BGRA32 = 3
...
export enum MikanDepthBufferType {
  NOCOLOR = 0,
...
export enum MikanDisconnectCode {
  Normal = 1000,
  ProtocolError = 1002,
  NoStatus = 1005,
  AbnormalClose = 1006,
